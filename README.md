...
|7|Принятие решений в бизнесе на основе данных А/B-теста|Принятие решений в бизнесе|Необходимо приоритизировать гипотезы, запустить A/B-тест и проанализировать результаты|*pandas, numpy, matplotlib, scipy*|
|8|||||
|9|||||
|10|||||
|11|||||
